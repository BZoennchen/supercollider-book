...
A good example is the *European Commission* who states in their white paper that
...
The *object* can be harnessed for the good or the evil, for the ugly or the beautiful, and it's our prerogative to dictate its usage.
...
Via Kant and other thinkers of the *Enlightenment*, it led to a liberal Western society that, in theory, safeguards an individual's right to a fulfilling life. 
...
He posits that, paradoxically, no society can exist without some form of regulation but norms are formed within a social system.
...
Therefore, if the law does not regulate something, all the other mechanisms will.
...
He believes the normative structures of modern society are intertwined with *values* (or preferences).
...
In Western societies this led to power concentrated in the *Big Five*: Google, Facebook, Amazon, Apple, and Microsoft {cite}`rosengruen:2021`.

Similar to Lessig, Don Ihde discusses in *Technology and the Lifeworld* {cite}`ihde:1990`, technology as an expansion or limit of possibilities and {cite}`rosengruen:2022` argues and warns that western societies are currently shifting from *Rule of Law* to *Rule of Code*:
...
While licensing could introduce some safety measures, ultimately it would protect large corporations and obscure the inner workings of the technology that regulate regulations---it would serve *surveillance capitalism*.
...
It is a powerful kind of control like absolute determination.
