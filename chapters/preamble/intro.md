...
From this lack of certainty and clarity it seems natural that one starts doubting the direct access to an objective reality.
Such a thing might be ontologically 'true' but we cannot know and we cannot access it.
...
How can it be that mathematics never lets us down?
...
Arguably this fear was already present many times in the past.
...
Then we have to take *Capitalist Realism* {cite}`fisher:2016` seriously but it might be too easy and reductive to blame capitalism for everything.
...
In contrast, Martin Heidegger, with his concept of the [essence of technology](sec-essense-of-technology) {cite}`heidegger:1954b`, offers another explanation for this supposedly downfall.
...
Furthermore, while one can get great insights from Heidegger, he is still embraced by a certain kind of group who uses *degeneration* as a weapon against the new and anything they mark as other, alien---the enemy, the foreigner.
...
In the spirit of *Philosophy as Poetry* {cite}`rorty:2016`, I urge the reader to take this text not as something close to metaphysics but as a narrative or a theory that only tries to help to imagine what technology is or better how it works.