...
As a constructivist, I argue that our mind has no direct access to reality, instead reality emerges by interacting with it.
...
Consequently, the sense of an artwork is contingent and depends on how we and social systems produce sense.
...
We are limited by practicality, i.e., by things that are *Turing-computable* in a reasonable amount of time.
